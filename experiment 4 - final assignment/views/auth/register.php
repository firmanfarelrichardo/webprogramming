...
<body class="bg-slate-100 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500">Silakan isi data diri kamu</p>
        </div>
        ...
        <form action="../../actions/auth/register.php" method="POST" class="space-y-6">
            <div>
        ...
        <p class="mt-6 text-center text-sm text-slate-600">
            Sudah punya akun? 
            <a href="login.php" class="text-blue-600 hover:underline font-medium">Login disini</a>
        </p>
    </div>
